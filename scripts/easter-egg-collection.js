...
(function(window){
  "use strict";
    ...
    var init = function(data) {
      var qwop = document.getElementById('gif-pikachu');
      qwop.addEventListener('click', record)
    };
  
    var data = document.getElementById('gif-pikachu').dataset.src
    init(data);
})(window);
// GIF -- pikachu -- end
...
(function(window){
    ...
    var init = function(data) {
      var qwop = document.getElementById('gif-ghost');
      qwop.addEventListener('click', ghost)
    };
  
    var data = document.getElementById('gif-ghost').dataset.src
    init(data)
